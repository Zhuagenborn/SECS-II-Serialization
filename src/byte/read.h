...
//! An error code and a descriptive error message.
using Error = std::pair<std::errc, std::string>;

namespace err {

//! Make an error indicating the provided buffer is too small.
